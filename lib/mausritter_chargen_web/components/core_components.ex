defmodule MausritterChargenWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MausritterChargenWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MausritterChargenWeb.Gettext, "errors", msg, opts)
    end
  end
